...
#define ERR_PARSE_AMBIENT_RATIO "Ambient light ratio is invalid. Must be between 0 and 1."
...
#define ERR_PARSE_SPOT_BRIGHT "Spot light brightness is invalid. Must be a positive value."
...
#define ERR_PARSE_CAM_FOV "Camera field of view is invalid. Must be between 0 and 180"
...
#define ERR_PARSE_SPHERE_INVALID_DIAM "Sphere diameter is invalid. Must be a positive value."
...
#define ERR_PARSE_CYLINDER_DIAM "Cylinder diameter is invalid. Must be a positive value."
#define ERR_PARSE_CYLINDER_HEIGHT "Cylinder height is invalid. Must be a positive value."
...
#define ERR_PARSE_CONE_ANGLE "Cone angle is invalid. Must be between 0 and 90 degrees."
#define ERR_PARSE_CONE_HEIGHT "Cone height is invalid. Must be a positive value."
