...
/*   Updated: 2024/03/06 11:06:36 by mchenava         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mesh_to_scene(t_rt *rt, t_mesh *mesh)
{
	...
	rt->scene.meshes = ft_realloc(rt->scene.meshes, (rt->scene.mesh_count + 1)
			* sizeof(t_mesh), rt->scene.mesh_count * sizeof(t_mesh));
